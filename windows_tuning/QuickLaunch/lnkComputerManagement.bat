...
var 
    ...
    hotkey = 'CTRL+SHIFT+ALT+M', // NOTE: Shortcut keys do not work for items on the Quick Launch bar.
    lnkName = 'Computer Management',
    arguments = '',
    targetPath =  system32 + '\\CompMgmtLauncher.exe',
...
oShellLink.IconLocation = targetPath;
